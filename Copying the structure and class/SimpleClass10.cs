...
namespace Copying_the_structure_and_class
{
    public class SimpleClass10
    {
        ...
        public SimpleClass10(int field1, int field2, int field3, int field4, int field5, int field6, int field7, int field8, int field9, int field10)
        {
            Field1 = field1;
            Field2 = field2;
            Field3 = field3;
        ...
        public SimpleClass10 DeepCopy()
        {
            return new SimpleClass10(
